...
# Input 설정
path = str(input("문서를 저장할 경로를 입력하세요: "))
ch_path = str(input("크롬드라이버가 저장된 경로를 입력하세요: "))
YourID = str(input("ID를 입력하세요: "))
...
dict = {'간호대학':{'sign':'0231', '간호학과':'0233'},
        ...
        '문과대학':{'sign':'0143', 'EML융합전공':'5672', '과학기술학융합전공':'4601', '국어국문학과':'0145',
                ...
                '사회학과':'0152', '서어서문학과':'0158', '심리학과':'0151', 'd언어학과':'4391',
        ...
        '사범대학':{'sign':'0234', '가정교육과':'0238', '교육학과':'0236', '국어교육과':'0240', '수학교육과':'0239',
                '역사교육과':'0243', '영어교육과':'0241', '지리교육과':'0242'},
...
def driver_control():
    ...
    # 로그인 과정
    driver.find_element_by_name('id').send_keys(YourID)
